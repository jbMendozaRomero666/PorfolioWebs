(function () {
    ...
    //muestra una alerta en la interfas 
    ...
    //Consultar el servidor para añadir una nueva tarea el proyecto actual
    async function agregarTarea(tarea) {
        ...
        try {
            ...
            if (resultado.tipo === 'exito') {
                ...
                //Agregar el objeto  de tarea al globla      de tareas
    ...
    async function actualizarTarea(tarea) {
        ...
        try {
            ...
            if (resultado.respuesta.tipo === 'exito') {
                ...
                //.map me crea un arreglo nuevo para que no modifique el que ya tengo 
                //lo sostiene un tiempo en memori
            ...
            if(resultado.resultado){
                ...
                //     );
                    ...
                    Swal.fire('Eliminado!' , resultado.mensaje,'success');
                      //crea un arreglo nuevo - trae todas las que no son iguales al id 
    ...
    function limpiarTareas() {
        ...
        const listadoTarea = document.querySelector('#listado-tareas');
        //verifica si hay un listado de tareas anteriores y los borra
