<fieldset>
  ...
  <input type="number" id="precio" name="propiedad[precio]" placeholder="Titulo Porpiedad" value="<?php echo s($propiedad->precio); ?>">
...
<fieldset>
  ...
  <select name="propiedad[vendedorId]" id="vendedor">
    <option selected disabled>--Select Vendedor--</option>
    <?php foreach ($vendedores as $vendedor) { ?>
      <option <?php if ($propiedad->vendedorId === $vendedor->id) {
                echo 'selected';
              } else {
                echo '';
...
<!--opcion tenaria  -->
<!--echo $porpiedad->vendedorId === $vendedor ->id ? 'selected' : '';-->